...
class CutAggregator(Aggregator):
    """Uses difference between succefssive frames to detect cuts.
    ...
    def aggregate(self, ldframe, **kwargs):
        ...
        fps = meta['fps'][0]
        cuts = DataFrame(cuts)
        cuts = cuts[cuts['frame_start'] < meta['frames'][0]]
        cuts['time_start'] = cuts['frame_start'] / fps
        cuts['time_end'] = cuts['frame_end'] / fps
        cuts['time_diff'] = (cuts['time_end'] - cuts['time_start'])
